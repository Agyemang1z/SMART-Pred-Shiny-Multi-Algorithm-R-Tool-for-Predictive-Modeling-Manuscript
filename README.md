...
<h1 align="center">Basic SMART-pred</h1>
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/Agyemang1z/SMART-Pred-Shiny-Multi-Algorithm-R-Tool-for-Predictive-Modeling-Manuscript"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/Agyemang1z/SMART-Pred-Shiny-Multi-Algorithm-R-Tool-for-Predictive-Modeling-Manuscript/issues">Report Bug</a>
    ·
    <a href="https://github.com/Agyemang1z/SMART-Pred-Shiny-Multi-Algorithm-R-Tool-for-Predictive-Modeling-Manuscript/issues">Request Feature</a>
  </p>
</div>
...
1. Clone the repo
   ```sh
   git clone https://github.com/Agyemang1z/SMART-Pred-Shiny-Multi-Algorithm-R-Tool-for-Predictive-Modeling-Manuscript.git
   ```
